...
async def async_setup_entry(
    ...
    def handle_devices(msg):
        ...
        for device_name in devices:
            valid_unique_ids.add(f"ir_remote_{prefix}_{device_name}_multipress_count")
            valid_unique_ids.add(f"ir_remote_{prefix}_{device_name}_multipress_delay")
...
class MultiPressCountNumber(NumberEntity):
    def __init__(self, hass: HomeAssistant, prefix: str, device_name: str, entry_id: str) -> None:
        ...
        self._device = device_name
        self._entry_id = entry_id
        self._attr_name = f"{device_name.replace('_', ' ').title()} Multi-Press Count"
...
class MultiPressDelayNumber(NumberEntity):
    def __init__(self, hass: HomeAssistant, prefix: str, device_name: str, entry_id: str) -> None:
        ...
        self._device = device_name
        self._entry_id = entry_id
        self._attr_name = f"{device_name.replace('_', ' ').title()} Multi-Press Delay"
